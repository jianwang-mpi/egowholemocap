...
def convert_renderpeople_mixamo_dataset(base_path, mode='train'):
    ...
    for identity_name in identity_name_list:
        ...
        out_identity_path = os.path.join(base_path, f'{identity_name}_with_original.pkl')
        ...
        seq_data['data_list'][identity_name] = data_identity
    # save pkl
    out_path = os.path.join(base_path, 'renderpeople_mixamo_labels_with_original.pkl')
