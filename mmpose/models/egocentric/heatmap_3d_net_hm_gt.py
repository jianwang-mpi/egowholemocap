...
from mmpose.models.builder import build_head, HEADS, build_loss
...
class Heatmap3DHMGTNet(nn.Module):
    """
    3D heatmap regression head for egocentric full body pose estimation
    note:trained and evaluated with generated 3D heatmap ground truth
    """
    def __init__(self,
                 in_channels=768,
                 num_deconv_layers=2,
        ...
        super(Heatmap3DHMGTNet, self).__init__()
    ...
    def get_loss(self, output, keypoints_3d, keypoint_3d_visible=None):
