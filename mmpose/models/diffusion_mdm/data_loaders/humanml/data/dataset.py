...
from mmpose.models.diffusion_mdm.data_loaders.humanml.utils.word_vectorizer import WordVectorizer
from mmpose.models.diffusion_mdm.data_loaders.humanml.utils.get_opt import get_opt
...
class HumanML3D(data.Dataset):
    def __init__(self, mode, datapath='./dataset/humanml_opt.txt', split="train", **kwargs):
        ...
        if os.name == 'nt':
            abs_base_path = r'Z:\EgoMocap\work\EgocentricHand\motion-diffusion-model'
        else:
            abs_base_path = r'/CT/EgoMocap/work/EgocentricHand/motion-diffusion-model'
