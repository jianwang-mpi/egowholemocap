...
"""
from mmpose.models.diffusion_mdm.utils.fixseed import fixseed
import os
import numpy as np
import torch
...
def main():
    ...
    if args.edit_mode == 'in_between':
        ...
        model_kwargs['y']['inpainting_mask'] = torch.tensor(humanml_utils.HML_LOWER_BODY_MASK_w_global, dtype=torch.bool,
