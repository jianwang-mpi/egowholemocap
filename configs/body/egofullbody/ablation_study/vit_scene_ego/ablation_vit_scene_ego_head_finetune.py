...
evaluation = dict(
    res_folder='/CT/EgoMocap/work/EgocentricFullBody/work_dirs/ablation_vit_scene_ego_head_finetune',
    metric='mpjpe',
    save_best='mpjpe',
    rule='less'
)
...
batch_size = 24
load_from = '/CT/EgoMocap/work/EgocentricFullBody/work_dirs/ablation_vit_scene_ego_head/epoch_2.pth'

log_config = dict(
    interval=50,
    hooks=[
        dict(type='TextLoggerHook'),
        dict(type='WandbLoggerHook', init_kwargs=dict(project='ablation_vit_scene_ego_head_finetune')),
    ])
