...
evaluation = dict(
    res_folder='/CT/EgoMocap/work/EgocentricFullBody/work_dirs/resnet_256x256_pose_2d_train',
    metric='pck',
    save_best='pck'
)
...
load_from = '/CT/EgoMocap/work/EgocentricFullBody/resources/pretrained_models/res50_mpii_256x256.pth'

log_config = dict(
    interval=50,
    hooks=[
        dict(type='TextLoggerHook'),
        dict(type='WandbLoggerHook', init_kwargs=dict(project='resnet_256x256_pose_2d_train')),
    ])
