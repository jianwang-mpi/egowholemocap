...
evaluation = dict(
    res_folder='/CT/EgoMocap/work/EgocentricFullBody/work_dirs/ablation_vit_egopw_global_ego',
    metric='pa-mpjpe',
    save_best='pa-mpjpe',
    rule='less'
)
...
load_from = '/CT/EgoMocap/work/EgocentricFullBody/work_dirs/ablation_vit_mo2cap2_head_finetune/best_mpjpe_epoch_3.pth'

log_config = dict(
    interval=50,
    hooks=[
        dict(type='TextLoggerHook'),
        dict(type='WandbLoggerHook', init_kwargs=dict(project='ablation_vit_egopw_global_ego')),
    ])
