...
evaluation = dict(
    res_folder='/CT/EgoMocap/work/EgocentricFullBody/work_dirs/ablation_vit_xr_egopose_head_finetune',
    metric='mpjpe',
    save_best='mpjpe',
    rule='less'
)
...
load_from = '/CT/EgoMocap/work/EgocentricFullBody/work_dirs/ablation_vit_xr_egopose_head_finetune/previous_best_mpjpe.pth'

log_config = dict(
    interval=50,
    hooks=[
        dict(type='TextLoggerHook'),
        dict(type='WandbLoggerHook', init_kwargs=dict(project='ablation_xr_finetune', name='ablation_vit_xr_egopose_head_finetune')),
    ])
