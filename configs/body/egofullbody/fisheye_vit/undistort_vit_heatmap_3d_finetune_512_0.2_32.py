...
evaluation = dict(
    res_folder='/CT/EgoMocap/work/EgocentricFullBody/work_dirs/undistort_vit_heatmap_3d_finetune_512_0.2_32',
    metric='mpjpe',
    save_best='mpjpe',
    rule='less'
)
...
load_from = '/CT/EgoMocap/work/EgocentricFullBody/work_dirs/undistort_vit_heatmap_3d_0.2_32/epoch_1.pth'
