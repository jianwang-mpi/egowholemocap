...
evaluation = dict(
    res_folder='/CT/EgoMocap/work/EgocentricFullBody/work_dirs/undistort_vit_heatmap_3d_finetune_512_0.2',
    metric='mpjpe',
    save_best='mpjpe',
    rule='less'
)
...
load_from = '/CT/EgoMocap/work/EgocentricFullBody/work_dirs/undistort_vit_heatmap_3d_finetune_size_0.2/best_mpjpe_epoch_26.pth'

log_config = dict(
    interval=50,
    hooks=[
        dict(type='TextLoggerHook'),
        dict(type='WandbLoggerHook', init_kwargs=dict(project='undistort_vit_heatmap_3d_finetune', name='img_512_size_0.2')),
    ])
...
model = dict(
    ...
    backbone=dict(
        ...
        fisheye2sphere_configs=dict(
            type='UndistortPatch',
            input_feature_height=512,
            input_feature_width=512,
            image_h=1024,
            image_w=1280,
