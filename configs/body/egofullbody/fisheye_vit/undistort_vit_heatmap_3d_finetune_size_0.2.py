...
evaluation = dict(
    res_folder='/CT/EgoMocap/work/EgocentricFullBody/work_dirs/undistort_vit_heatmap_3d_finetune_epoch_30',
    metric='mpjpe',
    save_best='mpjpe',
    rule='less'
)
...
load_from = '/CT/EgoMocap/work/EgocentricFullBody/work_dirs/undistort_vit_heatmap_3d/best_mpjpe_epoch_1.pth'

log_config = dict(
    interval=50,
    hooks=[
        dict(type='TextLoggerHook'),
        dict(type='WandbLoggerHook', init_kwargs=dict(project='undistort_vit_heatmap_3d_finetune', name='size_0.2')),
    ])
