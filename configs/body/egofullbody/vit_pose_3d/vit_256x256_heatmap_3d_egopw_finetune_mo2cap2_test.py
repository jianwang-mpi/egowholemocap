...
evaluation = dict(
    res_folder='/CT/EgoMocap/work/EgocentricFullBody/work_dirs/vit_256x256_heatmap_3d_egopw_finetune_mo2cap2_test',
    metric='pa-mpjpe',
    save_best='pa-mpjpe',
    rule='less'
)
...
log_config = dict(
    ...
    hooks=[
        ...
        dict(type='WandbLoggerHook', init_kwargs=dict(project='vit_256x256_heatmap_3d_egopw_finetune_mo2cap2_test'))
    ])
...
data = dict(
    ...
    train=dict(
        type='ConcatDataset',
        datasets=[egopw_finetune_dataset_cfg, mo2cap2_test_dataset_cfg],
    ),
    val=dict(
        type='Mo2Cap2TestDataset',
        data_cfg=data_cfg,
