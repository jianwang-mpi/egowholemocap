...
evaluation = dict(
    res_folder='/CT/EgoMocap/work/EgocentricFullBody/work_dirs/vit_256x256_heatmap_3d_egopw_finetune',
    metric='pa-mpjpe',
    save_best='pa-mpjpe',
    rule='less'
)
...
load_from = '/CT/EgoMocap/work/EgocentricFullBody/work_dirs/vit_256x256_heatmap_3d/epoch_2.pth'

log_config = dict(
    interval=50,
    hooks=[
        dict(type='TextLoggerHook'),
        dict(type='WandbLoggerHook', init_kwargs=dict(project='vit_256x256_heatmap_3d_egopw_finetune'))
    ])
