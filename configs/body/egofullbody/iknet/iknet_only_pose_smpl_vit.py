...
evaluation = dict(
    res_folder='/CT/EgoMocap/work/EgocentricFullBody/work_dirs/iknet_only_pose_smpl_vit',
    metric='mpjpe',
    save_best='mpjpe',
    rule='less'
)
...
log_config = dict(
    ...
    hooks=[
        ...
        dict(type='WandbLoggerHook', init_kwargs=dict(project='iknet_only_pose_smpl_vit')),
    ])
...
model = dict(
    ...
    pose_network_load_path='/CT/EgoMocap/work/EgocentricFullBody/work_dirs/vit_256x256_heatmap_3d/best_mpjpe_epoch_7.pth',
