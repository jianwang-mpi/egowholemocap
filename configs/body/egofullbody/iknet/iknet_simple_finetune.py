...
optimizer = dict(
    ...
    lr=5e-4,
    # paramwise_cfg=dict(
    #     custom_keys={'pose_network': dict(lr_mult=0.01)}
    # )
)
...
evaluation = dict(
    res_folder='/CT/EgoMocap/work/EgocentricFullBody/work_dirs/iknet_simple_finetune',
    metric='mpjpe',
    save_best='mpjpe',
    rule='less'
)
...
log_config = dict(
    ...
    hooks=[
        ...
        dict(type='WandbLoggerHook', init_kwargs=dict(project='iknet_simple_finetune')),
    ])
