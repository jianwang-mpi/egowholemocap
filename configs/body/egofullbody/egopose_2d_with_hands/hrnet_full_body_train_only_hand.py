...
evaluation = dict(
    res_folder='/CT/EgoMocap/work/EgocentricFullBody/work_dirs/hrnet_full_body_train_only_hand',
    metric='pck',
    save_best='pck',
    rule='greater'
)
...
log_config = dict(
    ...
    hooks=[
        ...
        dict(type='WandbLoggerHook', init_kwargs=dict(project='hrnet_full_body_train_only_hand')),
    ])
