...
log_config = dict(
    ...
    hooks=[
        ...
        dict(type='WandbLoggerHook', init_kwargs=dict(project='hrnet_256x256_renderpeople_mixamo_full_body_2d')),
    ])
...
val_pipeline = [
    ...
    dict(
        ...
        meta_keys=['image_file', 'target', 'target_weight', 'joints_2d', 'joints_3d',
                   'joints_3d_visible', 'keypoints_2d_visible']),
]
