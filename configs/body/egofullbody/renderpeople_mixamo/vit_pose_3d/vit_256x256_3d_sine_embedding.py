...
evaluation = dict(
    res_folder='/CT/EgoMocap/work/EgocentricFullBody/work_dirs/vit_256x256_3d_sine_embedding',
    metric='mpjpe',
    save_best='mpjpe',
    rule='less'
)
...
log_config = dict(
    ...
    hooks=[
        ...
        dict(type='WandbLoggerHook', init_kwargs=dict(project='vit_256x256_3d_sine_embedding')),
    ])
