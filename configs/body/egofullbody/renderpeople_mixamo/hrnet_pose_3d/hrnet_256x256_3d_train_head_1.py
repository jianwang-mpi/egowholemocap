...
evaluation = dict(
    res_folder='/CT/EgoMocap/work/EgocentricFullBody/work_dirs/hrnet_256x256_3d_train_head_1',
    metric='mpjpe',
    save_best='mpjpe',
    rule='less'
)
...
load_from = '/CT/EgoMocap/work/EgocentricFullBody/work_dirs/hrnet_h36m_256x256_pose_2d_train/epoch_3.pth'

log_config = dict(
    interval=50,
    hooks=[
        dict(type='TextLoggerHook'),
        dict(type='WandbLoggerHook', init_kwargs=dict(project='hrnet_256x256_3d_renderpeople_mixamo', name='head_1')),
    ])
