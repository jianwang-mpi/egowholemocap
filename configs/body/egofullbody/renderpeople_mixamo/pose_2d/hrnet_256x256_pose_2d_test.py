...
evaluation = dict(
    # res_folder='/CT/EgoMocap/work/EgocentricFullBody/work_dirs/hrnet_256x256_pose_2d_test/keypoint_results.pkl',
    metric='pck',
    save_best='pck',
    rule='greater'
)
...
model = dict(
    ...
    pretrained='https://download.openmmlab.com/mmpose/face/darkpose/hrnetv2_w18_aflw_256x256_dark-219606c0_20210125.pth',
    backbone=dict(
        type='HRNet',
        in_channels=3,
        extra=dict(
