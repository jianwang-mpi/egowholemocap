...
evaluation = dict(
    res_folder='/CT/EgoMocap/work/EgocentricFullBody/work_dirs/diffusion_full_body_train_uncond_global_studio',
    metric='mpjpe',
    save_best='mpjpe',
    rule='less'
)
...
load_from = '/CT/EgoMocap/work/EgocentricFullBody/work_dirs/diffusion_full_body_train_uncond_global/epoch_12.pth'
...
data = dict(
    ...
    train=dict(
        ...
        data_path_list='/CT/EgoMocap/work/EgocentricFullBody/dataset_files/diffusion_fullbody_studio/features_seqs_196.pkl',
        seq_len=seq_len,
