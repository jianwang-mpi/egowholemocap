...
evaluation = dict(
    res_folder='/CT/EgoMocap/work/EgocentricFullBody/work_dirs/diffusion_left_hand_train_skip_1_j_20',
    metric='mpjpe',
    save_best='mpjpe',
    rule='less'
)
...
log_config = dict(
    ...
    hooks=[
        ...
        dict(type='WandbLoggerHook', init_kwargs=dict(project='diffusion_left_hand_train_skip_1_j_20', name='left_hand_train')),
    ])
...
train_pipeline = [
    ...
    dict(type='PreProcessHandMotion', normalize=True, mean_std_path=mean_std_path, use_20_joints=True),
