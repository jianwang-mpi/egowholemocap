...
evaluation = dict(
    res_folder='/CT/EgoMocap/work/EgocentricFullBody/work_dirs/diffusion_left_hand_train_skip_1_j_21_no_norm',
    metric='mpjpe',
    save_best='mpjpe',
    rule='less'
)
...
log_config = dict(
    ...
    hooks=[
        ...
        dict(type='WandbLoggerHook', init_kwargs=dict(project='diffusion_left_hand_train_skip_1_j_21_no_norm',
                                                      name='left_hand_train')),
    ])
...
train_pipeline = [
    ...
    dict(type='PreProcessHandMotion', normalize=False, use_20_joints=False,
         align_hand_root=True),
    dict(type='PreProcessMo2Cap2BodyMotion', normalize=False, mean_std_path=mean_std_path),
