...
evaluation = dict(
    res_folder='/CT/EgoMocap/work/EgocentricFullBody/work_dirs/diffusion_full_body_train_uncond_ego_coord',
    metric='mpjpe',
    save_best='mpjpe',
    rule='less'
)
...
log_config = dict(
    ...
    hooks=[
        ...
        dict(type='WandbLoggerHook', init_kwargs=dict(project='diffusion_full_body_train_uncond_ego_coord')),
    ])
...
data = dict(
    ...
    train=dict(
        ...
        data_path_list='/CT/EgoMocap/work/EgocentricFullBody/dataset_files/diffusion_fullbody/ego_feature_seqs_196.pkl',
        seq_len=seq_len,
