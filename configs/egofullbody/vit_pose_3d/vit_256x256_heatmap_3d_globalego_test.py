...
load_from = '/CT/EgoMocap/work/EgocentricFullBody/work_dirs/vit_256x256_heatmap_3d_finetune/best_mpjpe_epoch_9.pth'

log_config = dict(
    interval=50,
    hooks=[
        dict(type='TextLoggerHook'),
        dict(type='WandbLoggerHook', init_kwargs=dict(project='vit_256x256_heatmap_3d_global_ego', name='heatmap_3d')),
    ])
