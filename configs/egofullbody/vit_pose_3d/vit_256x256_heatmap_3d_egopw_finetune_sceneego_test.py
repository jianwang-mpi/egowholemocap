...
log_config = dict(
    ...
    hooks=[
        ...
        dict(type='WandbLoggerHook', init_kwargs=dict(project='vit_256x256_heatmap_3d', name='egopw_finetune')),
    ])
...
val_pipeline = [
    ...
    dict(
        ...
        meta_keys=['image_file', 'keypoints_3d', 'keypoints_3d_visible', 'calib_board_pose', 'ext_id', 'seq_name']),
]
