...
evaluation = dict(
    res_folder='/CT/EgoMocap/work/EgocentricFullBody/work_dirs/vit_256x256_3d_joint_embed_lr_1e-4',
    metric='mpjpe',
    save_best='mpjpe',
    rule='less'
)
...
log_config = dict(
    ...
    hooks=[
        ...
        dict(type='WandbLoggerHook', init_kwargs=dict(project='vit_256x256_3d_joint_embed', name='lr_1e-4')),
    ])
...
model = dict(
    ...
    backbone=dict(
        ...
        num_keypoints=channel_cfg['num_output_channels'],
        patch_size=16,
        embed_dim=768,
        depth=6,
        num_heads=12,
    ...
    keypoint_head=dict(
        ...
        num_conv_layers=0,
        num_fc_layers=2,
        num_fc_features=(768 * channel_cfg['num_output_channels'], 768 * 4, 3 * channel_cfg['num_output_channels']),
