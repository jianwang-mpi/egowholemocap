...
evaluation = dict(
    res_folder='/CT/EgoMocap/work/EgocentricFullBody/work_dirs/fisheye_vit_256x256_3d',
    metric='mpjpe',
    save_best='mpjpe',
    rule='less'
)
...
log_config = dict(
    ...
    hooks=[
        ...
        dict(type='WandbLoggerHook', init_kwargs=dict(project='fisheye_vit_256x256_3d', )),
    ])
...
model = dict(
    ...
    keypoint_head=dict(
        ...
        num_conv_layers=0,
        num_fc_layers=2,
        num_fc_features=(138240, 1024, 45),
