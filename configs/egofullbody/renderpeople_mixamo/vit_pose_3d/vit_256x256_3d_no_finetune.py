...
evaluation = dict(
    res_folder='/CT/EgoMocap/work/EgocentricFullBody/work_dirs/vit_256x256_3d_no_finetune',
    metric='mpjpe',
    save_best='mpjpe',
    rule='less'
)
...
log_config = dict(
    ...
    hooks=[
        ...
        dict(type='WandbLoggerHook', init_kwargs=dict(project='vit_256x256_3d_no_finetune', name='head_256_512')),
    ])
...
model = dict(
    ...
    keypoint_head=dict(
        ...
        num_conv_layers=2,
        num_conv_filters=(512, 1024,),
        num_conv_kernels=(4, 4, ),
        num_conv_padding=(1, 1, ),
        num_conv_stride=(2, 2, ),
        num_fc_layers=2,
