...
log_config = dict(
    ...
    hooks=[
        ...
        dict(type='WandbLoggerHook', init_kwargs=dict(project='egofullbody_test_globalegomocap')),
    ])
...
model = dict(
    ...
    pretrained_body_pose='/CT/EgoMocap/work/EgocentricFullBody/work_dirs/vit_256x256_heatmap_3d_egopw_finetune/best_pa-mpjpe_epoch_2.pth',
    pretrained_hand_detection='/CT/EgoMocap/work/EgocentricFullBody/work_dirs/hrnet_full_body_finetune_only_hand/epoch_4.pth',
    pretrained_hand_pose_estimation='/CT/EgoMocap/work/EgocentricFullBody/work_dirs/hands4whole_train/epoch_2.pth',
)
...
val_pipeline = [
    ...
    dict(type='Collect',
         keys=['img', 'img_original'],
         meta_keys=['image_file', 'keypoints_3d', 'keypoints_3d_visible', 'seq_name'
                    ]),
]
