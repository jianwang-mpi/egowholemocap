...
evaluation = dict(
    res_folder='/CT/EgoMocap/work/EgocentricFullBody/work_dirs/fisheye_vit_heatmap_3d',
    metric='mpjpe',
    save_best='mpjpe',
    rule='less'
)
...
log_config = dict(
    ...
    hooks=[
        ...
        dict(type='WandbLoggerHook', init_kwargs=dict(project='fisheye_vit_heatmap_3d', )),
    ])
