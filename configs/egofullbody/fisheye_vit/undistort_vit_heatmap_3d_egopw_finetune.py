...
evaluation = dict(
    res_folder='/CT/EgoMocap/work/EgocentricFullBody/work_dirs/undistort_vit_heatmap_3d_egopw_finetune',
    metric='pa-mpjpe',
    save_best='pa-mpjpe',
    rule='less'
)
...
log_config = dict(
    ...
    hooks=[
        ...
        dict(type='WandbLoggerHook', init_kwargs=dict(project='undistort_vit_heatmap_3d_egopw_finetune', name='size_0.2_better_init')),
    ])
