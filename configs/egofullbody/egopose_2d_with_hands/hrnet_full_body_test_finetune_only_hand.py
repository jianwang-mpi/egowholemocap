...
load_from = '/CT/EgoMocap/work/EgocentricFullBody/work_dirs/hrnet_full_body_finetune_only_hand/best_pck_epoch_10.pth'
...
val_pipeline = [
    ...
    dict(
        ...
        meta_keys=['image_file', 'target', 'keypoints_2d', 'joints_2d', 'joints_3d', 'joints_3d_visible',
                   'keypoints_2d_visible']),
]
