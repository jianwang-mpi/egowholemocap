...
evaluation = dict(
    res_folder='/CT/EgoMocap/work/EgocentricFullBody/work_dirs/hands4whole_train_finetune_position',
    metric='hand-mpjpe',
...
log_config = dict(
    ...
    hooks=[
        ...
        dict(type='WandbLoggerHook', init_kwargs=dict(project='hands4whole_train')),
    ])

model = dict(
    type='EgoHandPose',
    pretrained='/CT/EgoMocap/work/EgocentricHand/Hand4Whole_RELEASE/demo/hand/snapshot_12.pth.tar',
)
