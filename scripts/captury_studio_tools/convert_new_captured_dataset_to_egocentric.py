...
def main():
    ...
    bvh_file_path = fr'X:\ScanNet\work\05-08-22\{seq_name}\unknown.bvh'
    previous_local_gt_path = fr'X:\ScanNet\work\egocentric_view\05082022\{seq_name}\local_pose_gt_with_hand_old.pkl'

    save_path = fr'X:\ScanNet\work\egocentric_view\05082022\{seq_name}\local_pose_gt_with_hand.pkl'
