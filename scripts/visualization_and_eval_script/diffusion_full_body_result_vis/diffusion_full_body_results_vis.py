...
result_path = r'Z:/EgoMocap/work/EgocentricFullBody/work_dirs/diffusion_full_body_train_uncond_eb_stu_rp/outputs_11.pkl'
normalize = True
vis_skip_frame = 1
save = False
vis = False

save_dir = r'Z:/EgoMocap/work/EgocentricFullBody/vis_results/diffusion_full_body_train_uncond_eb_stu_rp/'
os.makedirs(save_dir, exist_ok=True)
view_point_save_path = os.path.join(save_dir, 'view_point.json')
render = True
save_viewpoint = False
only_hand = False
motion_id = [80, 90, 100, 110]
