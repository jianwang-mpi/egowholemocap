...
def main():
    if os.name == 'nt':
        ...
        save_dir = r'Z:\EgoMocap\work\EgocentricFullBody\vis_results\egopw_diffusion_results_with_hands'
    else:
        ...
        save_dir = '/CT/EgoMocap/work/EgocentricFullBody/vis_results/egopw_diffusion_results_with_hands'
    ...
    for i in range(2200, 2400, 1):
        ...
        egopw_data_path = os.path.join(data_dir, dir_name, human_name, seq_name, 'out', 'egopw_results.pkl')
        egopw_results = read_egopw_result(egopw_data_path)
        egopw_pose = egopw_results[image_name]
