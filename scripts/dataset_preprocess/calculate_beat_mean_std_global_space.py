...
if __name__ == '__main__':
    if os.name == 'nt':
        data_path = r'Z:\datasets01\nobackup\BEAT\beat_english_v0.2.1'
        save_mean_std_path = r'Z:\EgoMocap\work\EgocentricFullBody\dataset_files\beat\global_aligned_mean_std.pkl'
        save_data_path = r'Z:\EgoMocap\work\EgocentricFullBody\dataset_files\beat\global_aligned_smplx_joints.pkl'
    else:
        data_path = '/CT/datasets01/nobackup/BEAT/beat_english_v0.2.1'
        save_mean_std_path = '/CT/EgoMocap/work/EgocentricFullBody/dataset_files/beat/global_aligned_mean_std.pkl'
        save_data_path = '/CT/EgoMocap/work/EgocentricFullBody/dataset_files/beat/global_aligned_smplx_joints.pkl'
