...
def calculate_egobody_mean_std():
    ...
    dataset_cfg = dict(
        type='ConcatDataset',
        datasets=[studio_motion_dataset_config],
    )
...
if __name__ == '__main__':
    if os.name == 'nt':
        ...
        save_dir = r'Z:\EgoMocap\work\EgocentricFullBody\dataset_files\diffusion_fullbody_studio'
    else:
        ...
        save_dir = '/CT/EgoMocap/work/EgocentricFullBody/dataset_files/diffusion_fullbody_studio'
