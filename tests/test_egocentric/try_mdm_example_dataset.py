...
def try_amass_dataset():
    ...
    path_dict = {
        'seq1': r'Z:\EgoMocap\work\motion-diffusion-model\dataset\HumanML3D\new_joint_vecs\012314.npy'
    }

    dataset_cfg = dict(
        type='MDMExampleDataset',
        path_dict=path_dict,
        seq_len=196,
    ...
    for i in range(0, len(joint_location_seq), 1):
        pose_i = joint_location_seq[i]
