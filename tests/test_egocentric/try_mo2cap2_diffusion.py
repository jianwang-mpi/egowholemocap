...
def try_mo2cap2_dataset(data_id=0, vis=False):
...
if __name__ == '__main__':
    data_i = try_mo2cap2_dataset(data_id=5, vis=False)
    ...
    mdm_edit = Mo2Cap2Diffusion(model_path=mdm_model_path,
                       max_frames=196).cuda()
    mdm_edit.eval()
    with torch.no_grad():
