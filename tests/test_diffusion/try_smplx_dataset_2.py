...
def try_egobody_dataset(seq_id):
    ...
    pipeline = [
        ...
        PreProcessHandMotion(normalize=True, mean_std_path=r'Z:\EgoMocap\work\EgocentricFullBody\dataset_files\egobody\global_aligned_mean_std.pkl'),
        PreProcessMo2Cap2BodyMotion(normalize=True, mean_std_path=r'Z:\EgoMocap\work\EgocentricFullBody\dataset_files\egobody\global_aligned_mean_std.pkl'),
    ...
    dataset_cfg = dict(
        ...
        data_path_list=[{
            'path': r'Z:\EgoMocap\work\EgocentricFullBody\dataset_files\egobody\global_aligned_smplx_inputs.pkl',
            'frame_rate': 30
        }],
        seq_len=seq_len,
        pipeline=pipeline,
