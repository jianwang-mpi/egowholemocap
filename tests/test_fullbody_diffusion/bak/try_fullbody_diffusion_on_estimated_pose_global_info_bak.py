...
if os.name == "nt":
    ...
    diffusion_model_path = r'Z:\EgoMocap\work\EgocentricFullBody\work_dirs\diffusion_full_body_train_uncond_global\epoch_20.pth'
    ...
    diffusion_model_path = '/CT/EgoMocap/work/EgocentricFullBody/work_dirs/diffusion_full_body_train_uncond_global/epoch_20.pth'
...
def run_diffusion(data_id):
    ...
    full_body_pose_diffusion_refiner = RefineEdgeDiffusionHands(seq_len=196,
                                                                representation_dim=3 + (21 + 21 + 15) * 3).cuda()
