...
if os.name == "nt":
    ...
    hand4whole_network_pred_seq_path = r'Z:\EgoMocap\work\EgocentricFullBody\work_dirs\egofullbody_test_b_256_original_hand_model\results.pkl'
    ...
    diffusion_result_save_global_dir = r"Z:/EgoMocap/work/EgocentricFullBody/vis_results/paper_vis_diffusion_results_hands"

else:
    network_pred_seq_path = '/CT/EgoMocap/work/EgocentricFullBody/work_dirs/egofullbody_test_b_256/results.pkl'
    hand4whole_network_pred_seq_path = '/CT/EgoMocap/work/EgocentricFullBody/work_dirs/egofullbody_test_b_256_original_hand_model/results.pkl'
    ...
    diffusion_result_save_global_dir = "/CT/EgoMocap/work/EgocentricFullBody/vis_results/paper_vis_diffusion_results_hands"
...
def get_fullbody_motion_test_dataset():
    ...
    pipeline = [
        ...
        Collect(keys=['aligned_smplx_joints', 'global_smplx_joints',
                ...
                meta_keys=['gt_joints_3d', 'ego_camera_pose', 'smplx_root_trans', 'root_quat', 'global_smplx_joints',
                           'ext_id', 'seq_name'])
    ]
    ...
    hand4whole_dataset_cfg = dict(
        type='FullBodyMotionTestDataset',
        data_pkl_path=hand4whole_network_pred_seq_path,
        seq_len=seq_len,
        skip_frames=seq_len,
        pipeline=pipeline,
        split_sequence=True,
    ...
    hand4whole_dataset = build_dataset(hand4whole_dataset_cfg)
    print(f"length of dataset is: {len(fullbody_motion_test_dataset)}")
    return fullbody_motion_test_dataset, hand4whole_dataset
...
def run_diffusion(data_id):
    full_body_motion_dataset, hand4whole_dataset = get_fullbody_motion_test_dataset()
    data_i = get_data(full_body_motion_dataset, data_id, vis=False)

    data_i_hand4whole = get_data(hand4whole_dataset, data_id, vis=False)
    ...
    diffusion_results['hand4whole_result_left'] = np.zeros((data_i_hand4whole['global_smplx_joints'].shape[0],
                                                            21, 3))
    diffusion_results['hand4whole_result_right'] = np.zeros((data_i_hand4whole['global_smplx_joints'].shape[0],
                                                            21, 3))
    diffusion_results['hand4whole_result_left'][:, mano_left_idxs] = data_i_hand4whole['global_smplx_joints'][:, smplx_idxs_mano_left]
    diffusion_results['hand4whole_result_right'][:, mano_right_idxs] = data_i_hand4whole['global_smplx_joints'][:, smplx_idxs_mano_right]
...
def get_pred_gt_motion(data_pkl_path):
    ...
    left_hand_hand4whole_motion = diffusion_results['hand4whole_result_left']
    right_hand_hand4whole_motion = diffusion_results['hand4whole_result_right']
    ...
    # convert hand4whole hand pose from ego camera coordinate system to global coordinate system
    left_hand_hand4whole_motion_global = left_hand_hand4whole_motion
    right_hand_hand4whole_motion_global = right_hand_hand4whole_motion
    # left_hand_hand4whole_motion_global = convert_with_ego_camera(left_hand_hand4whole_motion, ego_camera_pose_list)
    # right_hand_hand4whole_motion_global = convert_with_ego_camera(right_hand_hand4whole_motion, ego_camera_pose_list)
    ...
    left_hand_hand4whole_motion_global = left_hand_hand4whole_motion_global - left_hand_hand4whole_motion_global[:,
                                                                              0:1] + left_hand_root
    right_hand_hand4whole_motion_global = right_hand_hand4whole_motion_global - right_hand_hand4whole_motion_global[:,
                                                                                0:1] + right_hand_root
    ...
    result = {'left_hand_pred_motion': left_hand_pred_motion,
              ...
              'left_hand_hand4whole_motion_global': left_hand_hand4whole_motion_global,
              'right_hand_pred_motion': right_hand_pred_motion,
              'right_hand_input_motion': right_hand_input_motion,
              'right_hand_hand4whole_motion_global': right_hand_hand4whole_motion_global,
